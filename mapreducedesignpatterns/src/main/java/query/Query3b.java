...
public class Query3b {
    public static class AnalyzePhaseMapper extends Mapper<Object, Text, Text, Text> {
        ...
        public void map(Object key, Text value, Context context)
            ...
            Double d = Double.valueOf(key.toString())*10;
    ...
    public static class ThirdMapper extends Mapper<Object, Text, IntWritable, Text> {
        ...
        public void map(Object key, Text value, Context context)
                throws IOException, InterruptedException {
            System.out.println("3MAPPER"+key.toString()+":"+Integer.valueOf(key.toString()));
    ...
    public static class TopicHierarchyReducer extends
        ...
        public void reduce(IntWritable key, Iterable<Text> values, Context context)
            ...
            for (Text t : values) {
             ...
             context.write(new Text(((Double)(Math.floor(films.getRatingAvgPrev()*10)/10)).toString()),new Text(films.getTitle()+":"+films.getRatingAvgLast()));
...
*/
        if (code == 0) {
            Job sampleJob = Job.getInstance(conf, "Query3b");
            sampleJob.setJarByClass(Query3b.class);
        ...
        /* Set input and output files */
            ...
            SequenceFileInputFormat.setInputPaths(sampleJob, unionStage);

            sampleJob.setOutputFormatClass(SequenceFileOutputFormat.class);
            SequenceFileOutputFormat.setOutputPath(sampleJob, outputStage);

        /* Submit the job and get completion code. */
            code = sampleJob.waitForCompletion(true) ? 0 : 2;
